        ...
        <div className="container px-5 py-14 mx-auto">
          <div className="text-center mb-20" data-aos="fade-up">
            ...
            >
              ...
              excepturi aut enim voluptates iste! Maxime voluptatum provident
              enim nam sequi.
            </p>
          </div>
          <div
            ...
            {skills.map((skill, index) => (
              ...
              >
                <div
                  ...
                  className="h-full p-6 rounded-xl border hover:border-cyan-500/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,255,255,0.15)]"
                >
